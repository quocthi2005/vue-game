  ...
  <div class="d-flex justify-content-center">
    ...
    class="mb-2"
        ...
        <b-card-text>
            ...
            Since it is open source feel free to contribute to this simple quiz Application here: <a target="_blank" href="https://github.com/quocthi2005/vue-game.git"> Github Repo </a>
        </b-card-text>
